...
import com.example.testtask0.ui.locations.LocationsFragmentDirections.Companion.actionLocationsFragmentToLocationFragment
...
class LocationsFragment : BaseFragment(R.layout.fragment_locations) {
    ...
    private fun onListItemSelected(location: Location) =
        findNavController().navigate(actionLocationsFragmentToLocationFragment(location))
